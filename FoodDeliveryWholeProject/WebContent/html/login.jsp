...
<html>
<head>
<link href="${pageContext.request.contextPath}/CSS/mainBody.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/CSS/mainButtons.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/CSS/menuButtons.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/CSS/regFields.css"
	rel="stylesheet" type="text/css" />
<meta charset="utf-8">
				...
				<form action="${pageContext.request.contextPath}/LoginServlet"
					...
					<div class="form">
						<label for="username" class="title">Username:</label> <input
							type="text" name="username" required="required" /><br />
					</div>
					<div class="form">
						<label for="password" class="title">Password:</label> <input
							type="password" id="password" name="password" required="required" />
					</div>
					<br> <a href="sign_up.jsp" style="margin-left: 140px;">Създай
						нов акаунт</a>
					<c:if test="${!empty sessionScope.failLog}">
						<a href="lostpass.jsp" style="margin-left: 20px;">Забравена
							парола</a>
					</c:if>
					<div class="form">
